...
private:
	...
	static vector<Value>
	ParseGroupInstances(const std::vector<std::pair<int, ParsedFixMessage::TagValue>> &ordered_tags, size_t start_pos,
	                    int group_count, const std::vector<int> &group_field_tags);
