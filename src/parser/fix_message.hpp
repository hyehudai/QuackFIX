...
struct ParsedFixMessage {
    ...
    // Constructor
    ParsedFixMessage() { clear(); }

    // Clear for reuse
    void clear() {
        msg_type = nullptr; msg_type_len = 0;
        sender_comp_id = nullptr; sender_comp_id_len = 0;
        target_comp_id = nullptr; target_comp_id_len = 0;
        msg_seq_num = nullptr; msg_seq_num_len = 0;
        sending_time = nullptr; sending_time_len = 0;
        cl_ord_id = nullptr; cl_ord_id_len = 0;
        order_id = nullptr; order_id_len = 0;
        exec_id = nullptr; exec_id_len = 0;
        symbol = nullptr; symbol_len = 0;
        side = nullptr; side_len = 0;
        exec_type = nullptr; exec_type_len = 0;
        ord_status = nullptr; ord_status_len = 0;
        price = nullptr; price_len = 0;
        order_qty = nullptr; order_qty_len = 0;
        cum_qty = nullptr; cum_qty_len = 0;
        leaves_qty = nullptr; leaves_qty_len = 0;
        last_px = nullptr; last_px_len = 0;
